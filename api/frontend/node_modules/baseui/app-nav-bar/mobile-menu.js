...
var MobileNavMenuItem = React.forwardRef(function (props, ref) {
  var item = props.item,
  ...
  if (item.PARENT_MENU_ITEM) {
    return React.createElement(_index3.MenuAdapter, _extends({}, restProps, {
      ref: ref,
      artwork: item.navExitIcon || _arrowLeft.default,
      artworkSize: _index3.ARTWORK_SIZES.LARGE
    }), React.createElement(_index3.ListItemLabel, null, item.label));
  }

  if (item.USER_TITLE_ITEM) {
    // Replace with a user menu item renderer
    return React.createElement(UserMenuProfileListItem, _extends({}, restProps, userMenuProfileListItemProps, {
      ref: ref
  ...
  return (// Replace with a main menu item renderer
    React.createElement(_index3.MenuAdapter, _extends({}, restProps, {
      ...
      artworkSize: _index3.ARTWORK_SIZES.LARGE
    }), React.createElement(_index3.ListItemLabel, null, mapItemToNode(item)))
  );
});
...
function MobileMenu(props) {
  ...
  var items = [].concat(_toConsumableArray(userItems.length ? [(_ref = {
    ...
    return _objectSpread({}, item, _defineProperty({}, USER_MENU_ITEM, true));
  ...
  menuProps.overrides = (0, _overrides.mergeOverrides)({
    ...
    ListItem: function ListItem(listItemProps) {
      return React.createElement(MobileNavMenuItem, _extends({}, listItemProps, {
  ...
  menuProps.overrides);
  return React.createElement(React.Fragment, null, React.createElement(SideMenuButton, _extends({
    onClick: toggleMenu
  }, sideMenuButtonProps), React.createElement(_menu.default, {
    size: '24px'
  })), React.createElement(MobileDrawer, _extends({
    anchor: _index2.ANCHOR.left,
    isOpen: isOpen,
    onClose: toggleMenu,
    size: '75%'
  }, drawerProps), React.createElement(MobileMenu, _extends({
