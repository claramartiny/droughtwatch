...
var UserMenuListItem = React.forwardRef(function (props, ref) {
  ...
  return React.createElement(_index3.MenuAdapter, _extends({}, props, {
    ref: ref,
...
function UserMenuComponent(props) {
  ...
  userMenuProps.overrides = (0, _overrides.mergeOverrides)({
    List: {
      component: React.forwardRef(function (_ref2, ref) {
        ...
        return React.createElement(_index4.StyledList, _extends({}, restProps, {
          ref: ref
        }), React.createElement(UserMenuProfileListItem, userMenuProfileListItemProps, React.createElement(_userProfileTile.default, {
          username: props.username,
  ...
  return React.createElement(_index5.StatefulPopover, {
  ...
  }, React.createElement(UserMenuButton, userMenuButtonProps, React.createElement(_index.Avatar, {
    name: username || '',
    src: userImgUrl,
    size: '32px'
