...
export function DataTable(props) {
  ...
  const normalizedWidths = React.useMemo(() => {
    ...
    if (gridRef.current) {
      ...
      const padding = Math.floor(remainder / props.columns.filter(c => c.fillWidth).length);
  ...
  }, [measuredWidths, resizeDeltas, browserScrollbarWidth, rows.length, props.columns]);
