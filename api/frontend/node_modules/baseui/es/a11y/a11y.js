...
function Violation(props) {
  ...
  }, React.createElement(Caption1, null, props.target), props.violations.map((violation, index) => React.createElement(Paragraph3, {
    key: index
...
export default function A11y(props) {
  ...
  return React.createElement(React.Fragment, null, React.createElement("span", {
    ref: child
  }, props.children), React.createElement("div", null, violationsByNode.map(([node, violations], index) => // eslint-disable-next-line flowtype/no-weak-types
