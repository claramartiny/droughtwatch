...
function CountrySelectDropdown(props) {
  ...
  if (!props.children.length) {
    return React.createElement(LocaleContext.Consumer, null, locale => React.createElement(EmptyState, emptyStateProps, noResultsMsg || locale.menu.noResultsMsg));
  }
  ...
  }, containerProps), React.createElement(AutoSizer, null, ({
    height,
    width
  }) => {
...
export default React.forwardRef((props, ref) => React.createElement(CountrySelectDropdown, _extends({}, props, {
  $forwardedRef: ref
})));