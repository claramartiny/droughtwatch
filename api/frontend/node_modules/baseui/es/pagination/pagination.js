...
export default class Pagination extends React.PureComponent {
  ...
  render() {
    ...
    return React.createElement(ThemeContext.Consumer, null, theme => React.createElement(LocaleContext.Consumer, null, locale => React.createElement(Root, _extends({
    ...
    }, maxLabelProps), `${labels && labels.preposition ? labels.preposition : locale.pagination.preposition || ''} ${numPages}`), React.createElement(Button, {
