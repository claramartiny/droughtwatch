...
export default class CalendarHeader extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "renderMonthYearDropdown", () => {
      ...
      }, monthYearSelectButtonProps), monthYearTitle, React.createElement(MonthYearSelectIconContainer, monthYearSelectIconContainerProps, React.createElement(TriangleDown, {
        title: "",
        overrides: {
          Svg: {
            props: {
  ...
  render() {
    ...
    return React.createElement(ThemeContext.Consumer, null, theme => React.createElement(LocaleContext.Consumer, null, locale => React.createElement(React.Fragment, null, React.createElement(CalendarHeader, _extends({}, calendarHeaderProps, {
