...
function (_React$Component) {
  ...
  function TreeNode() {
    ...
    _defineProperty(_assertThisInitialized(_this), "treeItemRef", React.createRef());
  ...
  _createClass(TreeNode, [{
    ...
    value: function render() {
      ...
      return React.createElement(TreeItem, _extends({
      ...
      }, (0, _overrides.getOverrideProps)(TreeItemOverride)), React.createElement(TreeLabel, _extends({
        ...
        label: label,
        overrides: overrides
      }, (0, _overrides.getOverrideProps)(TreeLabelOverride))), children && (isExpanded || renderAll) && React.createElement(TreeItemList, _extends({
        role: "group",
