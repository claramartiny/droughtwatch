...
var TreeLabel = function TreeLabel(_ref) {
  ...
  return _react.default.createElement(TreeItemContent, _extends({}, sharedProps, props), hasChildren && _react.default.createElement(IconContainer, _extends({}, sharedProps, (0, _overrides.getOverrideProps)(IconContainerOverride)), !isExpanded ? _react.default.createElement(_themeProvider.ThemeContext.Consumer, null, function (theme) {
    return theme.direction === 'rtl' ? _react.default.createElement(Left, _extends({}, sharedProps, LeftProps)) : _react.default.createElement(Right, _extends({}, sharedProps, RightProps));
