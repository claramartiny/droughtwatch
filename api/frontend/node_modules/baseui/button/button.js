...
function (_React$Component) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var sharedProps = _objectSpread({}, (0, _utils.getSharedProps)(this.props), {
      ...
      return React.createElement(BaseButton, _extends({
        ...
        onFocus: (0, _focusVisible.forkFocus)(_objectSpread({}, restProps, {}, baseButtonProps), this.handleFocus),
        onBlur: (0, _focusVisible.forkBlur)(_objectSpread({}, restProps, {}, baseButtonProps), this.handleBlur)
      ...
      }, React.createElement(_buttonInternals.default, this.props)), React.createElement(LoadingSpinnerContainer, _extends({}, sharedProps, loadingSpinnerContainerProps), React.createElement(LoadingSpinner, _extends({}, sharedProps, loadingSpinnerProps)))) : React.createElement(_buttonInternals.default, this.props));
    }
  }]);
