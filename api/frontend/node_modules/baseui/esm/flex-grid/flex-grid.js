...
export var BaseFlexGrid = React.forwardRef(function (_ref, ref) {
...
var FlexGridComponent = React.forwardRef(function (props, ref) {
  return React.createElement(FlexGrid, _extends({}, props, {
    forwardedRef: ref
  }));
});
