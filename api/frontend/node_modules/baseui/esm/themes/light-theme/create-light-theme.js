...
export default function createLightTheme() {
  ...
  var colorTokens = _objectSpread({}, defaultColorTokens, {}, customColorTokens);

  var theme = {
    animation: animation,
    borders: borders,
    breakpoints: breakpoints,
    colors: _objectSpread({}, colorTokens, {}, getComponentColorTokens(colorTokens), {}, getDeprecatedSemanticColorTokens(colorTokens), {}, getSemanticColorTokens(colorTokens)),
    direction: 'auto',
    grid: grid,
    lighting: lighting,
