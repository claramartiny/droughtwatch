...
function Options(props) {
  ...
  var buiRef = React.useRef(props.columns.map(function (_, index) {
    return getBuiId();
  }));
  ...
  }, locale.datatable.optionsLabel), props.searchable && React.createElement("div", {
    className: css({
  ...
  }, locale.datatable.optionsEmpty), React.createElement("ul", {
