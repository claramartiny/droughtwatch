...
var ActionButton = React.forwardRef(function (_ref, ref) {
  ...
  return React.createElement(ActionButtonContainer, actionButtonContainerProps, React.createElement(_index.Button, {
    ref: ref,
    overrides: {
      BaseButton: {
        style: {
...
function SnackbarElement(_ref2) {
  ...
  return React.createElement(React.Fragment, null, actionMessage && React.createElement("div", {
    className: css({
      position: 'absolute',
      left: '-10000px',
      top: '-10000px'
    ...
    ref: rootRef
  }, rootProps), React.createElement(Content, contentProps, (Boolean(StartEnhancer) || progress) && React.createElement(StartEnhancerContainer, startEnhancerContainerProps, StartEnhancer !== null && StartEnhancer !== undefined ? React.createElement(StartEnhancer, {
    size: 24
  }) : React.createElement(Spinner, _extends({
    $height: 24,
    $width: 24
  }, spinnerProps))), React.createElement(Message, _extends({
    $hasSuffix: Boolean(actionMessage)
  }, messageProps), message), actionMessage && !wrapActionButton && React.createElement(ActionButton, {
    ref: actionButtonRef,
    message: actionMessage,
    onClick: actionOnClick,
    overrides: overrides
  })), actionMessage && wrapActionButton && React.createElement(WrapActionButtonContainer, wrapActionButtonContainerProps, React.createElement(ActionButton, {
    ref: actionButtonRef,
    message: actionMessage,
    onClick: actionOnClick,
    overrides: overrides
