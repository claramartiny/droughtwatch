...
function FilterQuickControls(props) {
  ...
  }, locale.datatable.categoricalFilterSelectAll), React.createElement(_index.Button, {
    type: "button",
...
function CategoricalFilter(props) {
  ...
  }, !filteredCategories.length && React.createElement(_index6.Label3, null, locale.datatable.categoricalFilterEmpty), Boolean(filteredCategories.length) && filteredCategories.map(function (category, i) {
    return React.createElement("div", {
