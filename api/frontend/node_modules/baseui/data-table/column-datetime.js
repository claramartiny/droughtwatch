...
function DatetimeFilter(props) {
  ...
  }, locale.datatable.datetimeFilterRange), React.createElement(_index10.Button, {
    type: "button",
    overrides: {
      BaseButton: {
        style: {
  ...
  }, locale.datatable.datetimeFilterCategorical)), isRange && React.createElement("div", null, React.createElement(_index17.Select, {
    value: rangeOperator,
