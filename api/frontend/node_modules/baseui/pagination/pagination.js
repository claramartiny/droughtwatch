...
function (_React$PureComponent) {
  ...
  function Pagination() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getMenuOptions", (0, _memoizeOne.default)(function (numPages) {
      var menuOptions = [];
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      var _getOverrides3 = (0, _overrides.getOverrides)(overrides.MaxLabel, _styledComponents.StyledMaxLabel),
          _getOverrides4 = _slicedToArray(_getOverrides3, 2),
          MaxLabel = _getOverrides4[0],
          maxLabelProps = _getOverrides4[1];

      var _getOverrides5 = (0, _overrides.getOverrides)(overrides.DropdownContainer, _styledComponents.StyledDropdownContainer),
          _getOverrides6 = _slicedToArray(_getOverrides5, 2),
          DropdownContainer = _getOverrides6[0],
          dropdownContainerProps = _getOverrides6[1];

      var _getOverrides7 = (0, _overrides.getOverrides)(overrides.Select, _index2.Select),
      ...
      return React.createElement(_themeProvider.ThemeContext.Consumer, null, function (theme) {
        return React.createElement(_index.LocaleContext.Consumer, null, function (locale) {
          return React.createElement(Root, _extends({
          ...
          }, rootProps), React.createElement(_index3.Button, {
            ...
            onFocus: (0, _focusVisible.forkFocus)(dropdownContainerProps, _this2.handleFocus),
            onBlur: (0, _focusVisible.forkBlur)(dropdownContainerProps, _this2.handleBlur)
          ...
          }, maxLabelProps), "".concat(labels && labels.preposition ? labels.preposition : locale.pagination.preposition || '', " ").concat(numPages)), React.createElement(_index3.Button, {
