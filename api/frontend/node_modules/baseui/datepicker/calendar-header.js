...
function (_React$Component) {
  ...
  function CalendarHeader(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CalendarHeader).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_this), "renderMonthYearDropdown", function () {
      ...
      }, monthYearSelectButtonProps), monthYearTitle, React.createElement(MonthYearSelectIconContainer, monthYearSelectIconContainerProps, React.createElement(_triangleDown.default, {
        title: "",
        overrides: {
          Svg: {
            props: {
    ...
    value: function render() {
      ...
      return React.createElement(_themeProvider.ThemeContext.Consumer, null, function (theme) {
        return React.createElement(_index3.LocaleContext.Consumer, null, function (locale) {
          return React.createElement(React.Fragment, null, React.createElement(CalendarHeader, _extends({}, calendarHeaderProps, {
