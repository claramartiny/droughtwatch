...
function (_React$Component) {
  ...
  function StatefulComponent() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(StatefulComponent).apply(this, arguments));
  }

  _createClass(StatefulComponent, [{
    key: "render",
    value: function render() {
      return React.createElement(_statefulContainer.default, this.props, function (extendedProps) {
