...
function (_React$Component) {
  ...
  _createClass(BaseInput, [{
    ...
    value: function renderClear() {
      ...
      var iconSize = (_SIZE$mini$SIZE$compa2 = {}, _defineProperty(_SIZE$mini$SIZE$compa2, _constants.SIZE.mini, '14px'), _defineProperty(_SIZE$mini$SIZE$compa2, _constants.SIZE.compact, '20px'), _defineProperty(_SIZE$mini$SIZE$compa2, _constants.SIZE.default, '26px'), _defineProperty(_SIZE$mini$SIZE$compa2, _constants.SIZE.large, '32px'), _SIZE$mini$SIZE$compa2)[this.props.size];
